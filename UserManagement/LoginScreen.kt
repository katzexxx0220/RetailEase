...
fun LoginScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            when (loginState) {
                //if correct, navigate to the homescreen
                true -> {
                    viewModel.resetLoginState()
                    onNavigateHome()
                }
                //if false, ask to insert text again
                false -> {
